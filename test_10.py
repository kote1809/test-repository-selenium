...
def test_menu(driver):
    ...
    if sticker == 'New':
        ...
        font_price_hp = first_element_price.value_of_css_property('font-size')
        ...
        font_price_ep = first_element_price_page.value_of_css_property('font-size')
    ...
    #иначе у него стикер SALE и у него будет старая и новая цены
        ...
        if sticker == 'Sale':
            ...
            #сравнение размеров шрифтов старой и новой цен товара
            comparison_of_font(font_of_old_price_hp, font_of_new_price_ep)
